...
/**
 * Lazily-built, memoized Movies page data. Deferred until the page is
...
/**
 * Returns the Movies page's hero slides and content rails, building them on
...
export default function getMoviesData() {
  ...
  cache = buildMoviesData()
  return cache
}

/**
 * Builds the Movies page's hero slides and content rails from scratch.
 * @returns {{hero: object[], rails: object[]}}
 */
function buildMoviesData() {
