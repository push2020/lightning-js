...
/**
 * Lazily-built, memoized Shows page data. Deferred until the page is
...
/**
 * Returns the Shows page's hero slides and content rails, building them on
 * first call and reusing the cached result afterwards.
 * @returns {{hero: object[], rails: object[]}}
 */
export default function getShowsData() {
  if (cache) return cache
  cache = buildShowsData()
  return cache
}

/**
 * Builds the Shows page's hero slides and content rails from scratch.
 * @returns {{hero: object[], rails: object[]}}
 */
function buildShowsData() {
